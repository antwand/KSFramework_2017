...
// #else
//             UIController uiBase = uiObj.AddComponent(System.Type.GetType("KUI" + uiTemplateName + ", Assembly-CSharp")) as UIController;
//             //UIController uiBase = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(uiObj, "Assets/Plugins/KEngine/KEngine.UI/UGUIBridge.cs (58,35)", "KUI" + uiTemplateName) as UIController;
// #endif
